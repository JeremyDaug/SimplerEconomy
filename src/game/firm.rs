...
use crate::game::{
    actor::Actor, config::{firm_constants, GameConfig}, contract::Contract, deal::{
...
fn firm_tenderable(
    ...
    let split = orders::classify_on_hand(row, history.salability(good), &factuals.config.market);
...
mod firm {
    ...
    mod plan_should {
        ...
        fn plan_pace_is_faster_at_high_confidence() {
            ...
            let slow = super::super::plan::plan_pace(0.0, &cfg);
            let mid = super::super::plan::plan_pace(
                crate::game::config::firm_constants::CONFIDENCE_DEFAULT,
                &cfg,
            );
            let fast = super::super::plan::plan_pace(1.0, &cfg);
